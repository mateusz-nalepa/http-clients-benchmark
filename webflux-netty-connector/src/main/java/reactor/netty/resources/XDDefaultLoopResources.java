 ...
 * @since 0.6
 */
public class XDDefaultLoopResources extends AtomicLong implements LoopResources {
    ...
    public XDDefaultLoopResources(String prefix, int workerCount, boolean daemon) {
        this(prefix, -1, workerCount, daemon);
    }

    public XDDefaultLoopResources(String prefix, int selectCount, int workerCount, boolean daemon) {
        this(prefix, selectCount, workerCount, daemon, true);
    }

    public XDDefaultLoopResources(String prefix, int selectCount, int workerCount, boolean daemon, boolean colocate) {
...
//        System.out.println("onServer w poza ifem");
    ...
    EventLoopGroup cacheNativeClientLoops() {
        ...
        if (null == eventLoopGroup) {
            EventLoopGroup newEventLoopGroup = colocate
