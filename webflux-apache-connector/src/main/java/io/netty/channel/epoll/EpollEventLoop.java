...
public class EpollEventLoop extends SingleThreadEventLoop {
    ...
    protected void run() {
        ...
        for (;;) {
            Long startEpollEventLoopRun = System.nanoTime();
            try {
            ...
            Long endEpollEventLoopRun = System.nanoTime();
            Duration epollEventLoopRunDuration = Duration.ofNanos(endEpollEventLoopRun - startEpollEventLoopRun);
            Metrics.timer("epollEventLoopRunDuration").record(epollEventLoopRunDuration);
        }
    }
