...
//                                                long executeEndpointDuration = (executeEndTime - executeStartTime) / 1000000;
//                                                Metrics.timer("executeRequest").record(executeEndpointDuration, TimeUnit.MILLISECONDS);
                                                Duration executeEndpointDuration = Duration.ofNanos(executeEndTime - executeStartTime);
                                                Metrics.timer("executeRequest").record(executeEndpointDuration);
                                            }
