...
public class H2AsyncClientBuilder {
    ...
    private static class RequestInterceptorEntry {
        ...
        private RequestInterceptorEntry(final Position position, final HttpRequestInterceptor interceptor) {
    ...
    private static class ResponseInterceptorEntry {
        ...
        private ResponseInterceptorEntry(final Position position, final HttpResponseInterceptor interceptor) {
            this.position = position;
            this.interceptor = interceptor;
        }
    }
